        ...
        <footer ref={ref} className={'p-2 flex flex-col items-center gap-8 md:p-10'}>
            <div className={'flex flex-col gap-8 justify-center items-center'}>
                ...
                <div className={'flex gap-8'}>
                    <motion.div className={'w-36 h-24 rounded-full relative'}
                                animate={controls}
                    ...
                    >
                      <Image src={footerImage1} alt={''} className={'w-full h-full rounded-full'}/>
                        <div className={'absolute flex flex-col items-center justify-center top-0 h-full w-full rounded-full backdrop-blur-[1px]'}>
                            <div className={'select-none text-5xl pt-5 font-extrabold text-white flex flex-col items-center justify-center'}>^</div>
                        </div>
                    </motion.div>
                    <motion.div className={'w-36 h-24 rounded-full relative'}
                                animate={controls}
                    ...
                    >
                        ...
                        <div className={'absolute flex flex-col items-center justify-center top-0 h-full w-full rounded-full backdrop-blur-[1px]'}>
                            <div className={'select-none text-6xl pb-5 font-bold text-white flex flex-col items-center justify-center'}>[  ]</div>
                        </div>
                    </motion.div>
                    <motion.div className={'w-36 h-24 flex flex-col items-center justify-center rounded-full bg-gray-300 relative'}
                                animate={controls}
                                variants={footerVariant3}
                                initial='hidden'
                    >
                        <AiOutlineArrowRight className={'text-6xl font-bold text-white -rotate-45'}/>
                    </motion.div>
                    <motion.div className={'w-36 h-24 rounded-full relative'}
                                animate={controls}
                    ...
                    >
                        ...
                        <div className={'absolute flex flex-col items-center justify-center top-0 h-full w-full rounded-full backdrop-blur-[1px]'}>
                            <div className={'select-none text-6xl pt-5 font-extrabold text-white flex flex-col items-center justify-center'}>*</div>
                        </div>
                    </motion.div>
                </div>
            </div>
            ...
            >
                ...
                <div className={'flex flex-col items-center justify-around absolute top-0 rounded-[40px] backdrop-blur-sm w-full h-full'}>
                    <div className={'text-2xl md:text-5xl font-normal text-white'}>
                        JOIN NOW
                    </div>
                    <form className={'flex gap-2 items-center flex-col md:flex-row w-[70%] justify-around'}>
